...
#ifndef OHOS_DISTRIBUTED_SCREEN_SOURCE_HIDUMPER_H
#define OHOS_DISTRIBUTED_SCREEN_SOURCE_HIDUMPER_H
...
enum class HidumpFlag {
    UNKNOWN = 0,
    GET_HELP,
    DUMP_SOURCE_SCREEN_DATA,
    DUMP_SOURCE_SCREEN_DATA_RESTART,
};

class DscreenSourceHidumper {
    DECLARE_SINGLE_INSTANCE_BASE(DscreenSourceHidumper);
...
#endif // OHOS_DISTRIBUTED_SCREEN_SOURCE_HIDUMPER_H