...
namespace V1_0 {
void DScreenManagerTest1::SetUpTestCase(void) {}

void DScreenManagerTest1::TearDownTestCase(void) {}

void DScreenManagerTest1::SetUp() {}

void DScreenManagerTest1::TearDown() {}
 ...
 */
HWTEST_F(DScreenManagerTest1, Init_001, TestSize.Level1)
{
 ...
 * @tc.require: Issue Number
 */
HWTEST_F(DScreenManagerTest1, HandleScreenChange_001, TestSize.Level1)
{
 ...
 * @tc.require: Issue Number
 */
HWTEST_F(DScreenManagerTest1, AddToGroup_001, TestSize.Level1)
{
    std::shared_ptr<DScreen> changedScreen = nullptr;
 ...
 * @tc.require: Issue Number
 */
HWTEST_F(DScreenManagerTest1, RemoveFromGroup_001, TestSize.Level1)
{
    std::shared_ptr<DScreen> changedScreen = nullptr;
 ...
 * @tc.require: Issue Number
 */
HWTEST_F(DScreenManagerTest1, OnRegResult_001, TestSize.Level1)
{
    std::shared_ptr<IDScreenCallback> dScreenCallback = std::make_shared<DScreenCallback>();
 ...
 * @tc.require: Issue Number
 */
HWTEST_F(DScreenManagerTest1, OnUnregResult_001, TestSize.Level1)
{
    std::shared_ptr<IDScreenCallback> dScreenCallback = std::make_shared<DScreenCallback>();
    std::shared_ptr<DScreen> changedScreen = std::make_shared<DScreen>("devId000", "dhId000", dScreenCallback);
 ...
 * @tc.require: Issue Number
 */
HWTEST_F(DScreenManagerTest1, GetScreenDumpInfo_001, TestSize.Level1)
{
    std::string result;
 ...
 * @tc.require: Issue Number
 */
HWTEST_F(DScreenManagerTest1, EnableDistributedScreen_001, TestSize.Level1)
{
 ...
 * @tc.require: Issue Number
 */
HWTEST_F(DScreenManagerTest1, FindDScreenByScreenId_001, TestSize.Level1)
{
 ...
 * @tc.require: Issue Number
 */
HWTEST_F(DScreenManagerTest1, GetScreenDumpInfo_002, TestSize.Level1)
{
    std::string result;
    DScreenManager::GetInstance().GetScreenDumpInfo(result);
    EXPECT_EQ(false, result.empty());
 ...
 * @tc.require: Issue Number
 */
HWTEST_F(DScreenManagerTest1, HandleDScreenNotify_001, TestSize.Level1)
{
 ...
 * @tc.require: Issue Number
 */
HWTEST_F(DScreenManagerTest1, NotifyRemoteScreenService_001, TestSize.Level1)
{
    std::string devId = "devId111";
 ...
 * @tc.require: Issue Number
 */
HWTEST_F(DScreenManagerTest1, PublishMessage_001, TestSize.Level1)
{
    std::shared_ptr<IDScreenCallback> dScreenCallback = std::make_shared<DScreenCallback>();
 ...
 * @tc.require: Issue Number
 */
HWTEST_F(DScreenManagerTest1, NotifyRemoteSinkSetUp_001, TestSize.Level1)
{
    std::shared_ptr<IDScreenCallback> dScreenCallback = std::make_shared<DScreenCallback>();
    std::shared_ptr<DScreen> dScreen = std::make_shared<DScreen>("devId000", "dhId000", dScreenCallback);
 ...
 * @tc.require: Issue Number
 */
HWTEST_F(DScreenManagerTest1, HandleNotifySetUpResult_001, TestSize.Level1)
{
 ...
 * @tc.require: Issue Number
 */
HWTEST_F(DScreenManagerTest1, DisableDistributedScreen_001, TestSize.Level1)
{
