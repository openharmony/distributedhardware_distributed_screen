...
#ifndef OHOS_SOFTBUS_ADAPTER_SOFTBUS_PERMISSION_CHECK_H
#define OHOS_SOFTBUS_ADAPTER_SOFTBUS_PERMISSION_CHECK_H
...
#endif // OHOS_SOFTBUS_ADAPTER_SOFTBUS_PERMISSION_CHECK_H