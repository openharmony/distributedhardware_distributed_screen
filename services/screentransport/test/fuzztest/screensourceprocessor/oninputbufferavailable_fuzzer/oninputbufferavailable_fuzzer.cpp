...
#include "oninputbufferavailable_fuzzer.h"
...
void OnInputBufferAvailableFuzzTest(const uint8_t* data, size_t size)
{
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size)
{
    ...
    OHOS::DistributedHardware::OnInputBufferAvailableFuzzTest(data, size);
    return 0;
}
