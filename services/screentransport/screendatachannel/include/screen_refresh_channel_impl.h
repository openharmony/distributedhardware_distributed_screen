...
#ifndef OHOS_SCREEN_REFRESH_CHANNEL_IMPL_H
#define OHOS_SCREEN_REFRESH_CHANNEL_IMPL_H
...
class ScreenRefreshChannelImpl : public IScreenChannel,
    public ISoftbusListener,
    public std::enable_shared_from_this<ScreenRefreshChannelImpl> {
public:
    explicit ScreenRefreshChannelImpl(std::string peerDevId) : peerDevId_(peerDevId) {};
    ~ScreenRefreshChannelImpl() override = default;
...
private:
    static const constexpr char *LOG_TAG = "ScreenRefreshChannelImpl";
