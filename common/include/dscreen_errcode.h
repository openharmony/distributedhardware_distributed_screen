...
enum DScreenErrorCode {
    ...
    ERR_DH_SCREEN_SA_SET_IMAGESURFACE_FAIL = -500037,
    ERR_DH_SCREEN_SA_INIT_SOURCE_FAIL = -500038,
    ERR_DH_SCREEN_SA_CHECK_ENABLE_PERMISSION_FAIL = -500039,
    ...
    ERR_DH_SCREEN_ADAPTER_PERMISSION_DENIED = -52007,
    ERR_DH_SCREEN_ADAPTER_CONTEXT = -52008,
    // Encoder & Decoder
    ...
    ERR_DH_SCREEN_CODEC_PARTAIL_DATA_ERROR = -53008,
    ...
    ERR_DH_AV_TRANS_NULL_VALUE = -58000,
    ERR_DH_AV_TRANS_ILLEGAL_PARAM = -58001,
    ERR_DH_AV_TRANS_TIMEOUT = -58002,
    ERR_DH_AV_TRANS_LOAD_ERROR = -58003,
    ERR_DH_AV_TRANS_INIT_FAILED = -58004,
    ERR_DH_AV_TRANS_CREATE_CHANNEL_FAILED = -58005,
    ERR_DH_AV_TRANS_SETUP_FAILED = -58006,
    ERR_DH_AV_TRANS_START_FAILED = -58007,
